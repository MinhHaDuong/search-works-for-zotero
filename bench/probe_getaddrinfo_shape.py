...
apply: this is a measurement of the C library's resolver (glibc, on this
machine) and of the harness's tracer, not a run against a target.
"""
...
def measure(log_dir: Path) -> dict:
    ...
    return {
        ...
        "not_a_target_run": (
            ...
            "does not apply; this measures the C library's resolver and the tracer"
        ),
