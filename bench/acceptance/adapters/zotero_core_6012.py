    ...
    return Declaration(
        ...
        not_derived_state=(
            (
                ...
                "desktop entries exempted below. Of 1070 files created on the measured "
                "run, 953 fall under a declared root, 107 are the office suite's "
                "configuration, 1 the sound server's, 8 sit inside .cache, and 1 is "
                "this log. What could still fail it: a write at the top of the sandbox "
