...
def declaration(arena: Path, *, port: int = 23519) -> Declaration:
    ...
    return Declaration(
        ...
        process=(
            ...
            "The deviation came from one lane briefing and now appears on three "
            "adapters, so whether the contract's letter should carry a carve-out for "
            "coexistence plumbing is a standing question for the author and not three "
