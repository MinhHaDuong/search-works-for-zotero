...
FIGURES = [
    ...
    # ---- 0719, the library-level bench: the first run's ladder, strata, chain and cost.
    ('0719-generator/run.json', 'identity.scope.items_in_index', 0,
     {"v0719": 'The newest **{}** items of the personal'}),
    ('0719-generator/run.json', 'identity.scope.build.elapsed_s', 1,
     {"v0719": 'tool in **{} s**: **9 032** passages'}),
    ('0719-generator/run.json', 'identity.scope.build.status.passages', 0,
     {"v0719": 'tool in **1 014,4 s**: **{}** passages'}),
    ...
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.n', 0,
     {"v0719": '| vi → en | {} | 0 | 7 | 6 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.near_win', 0,
     {"v0719": '| vi → en | 13 | 0 | {} | 6 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.miss', 0,
     {"v0719": '| vi → en | 13 | 0 | 7 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.row_mrr', 3,
     {"v0719": '| 7 | 6 | {} | 0,449 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.work_mrr', 3,
     {"v0719": '| 7 | 6 | 0,115 | {} |'}),
