...
PROSE = {
    ...
    "v0711": ["verification/LIBRARY-CENSUS-0029.md"],
    "v0719": ["verification/GENERATOR-0719.md"],
...
FIGURES = [
    ...
    ("0577-service-ceiling/service-ceiling-rss.json", "batch_size_derivation.b.wall_ms", 1,
     {"t0577": "at q8 ({} ms)"}),
    # ---- 0577's second configuration, measured 2026-09-03 on the GPU host once the
    # author stopped the resident judge driver. Two artifacts, because the arm is only
    # readable against a control: the CUDA run, and the SAME machine's CPU run, which is
    # what separates the machine from the device. SPEC.md 5.2.8 binds the ceiling to the
    # reference machine, so none of these figures is a ceiling -- they are the disclosed
    # comparison reported beside it, and the prose says so in both homes.
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.1.peak_rss_mb", 1,
     {"t0577": "| cuda-1 | incumbent | \u2014 | **{} MB**",
    ...
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.4.peak_rss_mb", 1,
     {"t0577": "| cuda-4 | incumbent + candidate q8 | batch of 8 on the candidate | **{} MB**",
      "decisions": "Cell 4 is **{} MB** there against"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.4b.peak_rss_mb", 1,
     {"t0577": "| cuda-4b | incumbent + candidate q8 | a batch on each at once | **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.1b.peak_rss_mb", 1,
     {"t0577": "| cuda-1b | candidate q8 alone | \u2014 | **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.2b.peak_rss_mb", 1,
     {"t0577": "| cuda-2b | candidate q8 alone | batch of 8 | **{} MB**"}),
    # Device memory, anchored on the host-RSS cell that precedes it in the row. The two
    ...
    # rests on the SAME detector answering both ways in one run. Presence-only would not
    # do here -- the value must sit in the sentence that makes the claim.
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "device_controls.shipped_call_no_device_key.peak_rss_mb", 1,
     {"t0577": "report **{} MB** of host RSS with no device memory",
      "decisions": "holds **{} MB** of host RSS and no device memory"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "device_controls.explicit_cpu.peak_rss_mb", 1,
     {"t0577": "and **{} MB**, again with none,"}),
    # The zero-settle control arm on both devices. Without it the settled cells are a
    # number with no account of how it was read, which is the mistake the first
    # reference-machine run made and corrected.
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "controls_no_settle.1.peak_rss_mb", 1,
     {"t0577": "the controls read: cuda-1 **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "controls_no_settle.2.peak_rss_mb", 1,
     {"t0577": "cuda-2 **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "controls_no_settle.3.peak_rss_mb", 1,
     {"t0577": "cuda-3 **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "controls_no_settle.4.peak_rss_mb", 1,
     {"t0577": "cuda-4 **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "controls_no_settle.1.peak_rss_mb", 1,
     {"t0577": "CPU: cpu-1 **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "controls_no_settle.2.peak_rss_mb", 1,
     {"t0577": "cpu-2 **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "controls_no_settle.3.peak_rss_mb", 1,
     {"t0577": "cpu-3 **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "controls_no_settle.4.peak_rss_mb", 1,
     {"t0577": "cpu-4 **{} MB**"}),
    # The host control arm: the same machine on its CPU, running the shipped call.
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.1.peak_rss_mb", 1,
     {"t0577": "| cpu-1 | incumbent | \u2014 | **{} MB**",
      "decisions": "rest against **{} MB** for the same model"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.2.peak_rss_mb", 1,
     {"t0577": "| cpu-2 | incumbent | batch of 64 | **{} MB**",
      "decisions": "with it, 464,7 / **{}** /"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.3.peak_rss_mb", 1,
     {"t0577": "| cpu-3 | incumbent + candidate q8 | \u2014 | **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.4.peak_rss_mb", 1,
     {"t0577": "| cpu-4 | incumbent + candidate q8 | batch of 8 on the candidate | **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.4b.peak_rss_mb", 1,
     {"t0577": "| cpu-4b | incumbent + candidate q8 | a batch on each at once | **{} MB**",
      "decisions": "measured anywhere is **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.1b.peak_rss_mb", 1,
     {"t0577": "| cpu-1b | candidate q8 alone | \u2014 | **{} MB**"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.2b.peak_rss_mb", 1,
     {"t0577": "| cpu-2b | candidate q8 alone | batch of 8 | **{} MB**"}),
    # Per-cell spreads on both arms, presence-only: each sits in a table cell beside the
    # median it qualifies, so an anchor for one would carry the other's value inside it.
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.1.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.2.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.3.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.4.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.4b.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.1b.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "cells.2b.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.1.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.2.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.3.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.4.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.4b.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.1b.peak_rss_mb_spread", 1, {"t0577": None}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "cells.2b.peak_rss_mb_spread", 1, {"t0577": None}),
    # The batch sizes, derived per DEVICE from the ratified ~1 s quantum. They are the
    # load-bearing figures of the portability observation: the at-rest cells agree across
    # machines and the live-batch cells do not, because the quantum buys a bigger batch on
    # a faster device.
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "batch_size_derivation.a.size", 0,
     {"t0577": "**{}** and **8** passages under CUDA",
      "decisions": "the GPU host's CPU, **{}** under"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cuda.json", "batch_size_derivation.b.size", 0,
     {"t0577": "and **{}** passages under CUDA",
      "decisions": "the same batch of **{}** under CUDA"}),
    ("0577-service-ceiling/service-ceiling-rss-gpu-host-cpu.json", "batch_size_derivation.a.size", 0,
     {"t0577": "**{}** and **8** on this machine's CPU",
      "decisions": "for a batch of **{}** on that CPU"}),
    ...
    # an assertion -- the same driver on the same host DOES accelerate the other model.
    ...
    # ---- 0719, the library-level bench: the ruled run's ladder per lane and per mode, strata, chain, cost.
    ('0719-generator/run.json', 'identity.scope.records', 0,
     {"v0719": 'A seeded random sample of **{}** top-level records'}),
    ('0719-generator/run.json', 'identity.scope.children', 0,
     {"v0719": 'with their **{}** children.'}),
    ('0719-generator/run.json', 'proxy.requests', 0,
     {"v0719": 'The proxy served\n  **{}** requests, all GET'}),
    ('0719-generator/run.json', 'proxy.refused_non_get', 0,
     {"v0719": 'and refused **{}** other methods'}),
    ('0719-generator/run.json', 'identity.scope.build.elapsed_s', 1,
     {"v0719": "through the target's own tool in **{} s**"}),
    ('0719-generator/run.json', 'identity.scope.build.status.passages', 0,
     {"v0719": 'tool in **609,6 s**: **{}** passages'}),
    ('0719-generator/run.json', 'identity.scope.items_in_index', 0,
     {"v0719": 'back from the index file — **{}** items'}),
    ('0719-generator/run.json', 'sample.n', 0,
     {"v0719": '**Sample.** **{}** answer paragraphs drawn uniformly'}),
    ('0719-generator/run.json', 'sample.frame_pairs', 0,
     {"v0719": 'drawn uniformly from the **{}** (record,'}),
    ('0719-generator/run.json', 'sample.strata.format.pdf.achieved', 0,
     {"v0719": 'Formats: PDF **{}**, HTML'}),
    ('0719-generator/run.json', 'sample.strata.format.html.achieved', 0,
     {"v0719": 'Formats: PDF **71**, HTML **{}**'}),
    ('0719-generator/run.json', 'sample.language.answer.en', 0,
     {"v0719": 'English **{}**, Vietnamese'}),
    ('0719-generator/run.json', 'sample.language.answer.vi', 0,
     {"v0719": 'English **81**, Vietnamese\n  **{}**'}),
    ('0719-generator/run.json', 'questions.n', 0,
     {"v0719": 'All **{}** questions came from the model'}),
    ('0719-generator/run.json', 'questions.elapsed_ms_total', 0,
     {"v0719": 'the batch took **{} ms**'}),
    ('0719-generator/run.json', 'questions.cross_lingual', 0,
     {"v0719": "third were written in another of R7's default-path languages: **{}**"}),
    ('0719-generator/run.json', 'readings.query_wall_ms.first', 1,
     {"v0719": 'The first query took **{} ms**'}),
    ('0719-generator/run.json', 'readings.query_wall_ms.median_after_first', 1,
     {"v0719": 'the median of the rest was **{} ms**'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.n', 0,
     {"v0719": '| all | {} | 22 | 51 | 27 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.win', 0,
     {"v0719": '| all | 100 | {} | 51 | 27 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.near_win', 0,
     {"v0719": '| all | 100 | 22 | {} | 27 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.miss', 0,
     {"v0719": '| all | 100 | 22 | 51 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.row_mrr', 3,
     {"v0719": '| all | 100 | 22 | 51 | 27 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.work_mrr', 3,
     {"v0719": '| 22 | 51 | 27 | 0,226 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.same-language.n', 0,
     {"v0719": '| same language | {} | 21 | 43 | 6 |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.same-language.win', 0,
     {"v0719": '| same language | 70 | {} | 43 | 6 |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.same-language.near_win', 0,
     {"v0719": '| same language | 70 | 21 | {} | 6 |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.same-language.miss', 0,
     {"v0719": '| same language | 70 | 21 | 43 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.same-language.row_mrr', 3,
     {"v0719": '| same language | 70 | 21 | 43 | 6 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.same-language.work_mrr', 3,
     {"v0719": '| same language | 70 | 21 | 43 | 6 | 0,317 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.cross-lingual.n', 0,
     {"v0719": '| cross-lingual | {} | 1 | 8 | 21 |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.cross-lingual.win', 0,
     {"v0719": '| cross-lingual | 30 | {} | 8 | 21 |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.cross-lingual.near_win', 0,
     {"v0719": '| cross-lingual | 30 | 1 | {} | 21 |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.cross-lingual.miss', 0,
     {"v0719": '| cross-lingual | 30 | 1 | 8 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.cross-lingual.row_mrr', 3,
     {"v0719": '| cross-lingual | 30 | 1 | 8 | 21 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.cross-lingual.work_mrr', 3,
     {"v0719": '| cross-lingual | 30 | 1 | 8 | 21 | 0,013 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.en->en.n', 0,
     {"v0719": '| en → en | {} | 20 | 35 | 4 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.en->en.win', 0,
     {"v0719": '| en → en | 59 | {} | 35 | 4 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.en->en.near_win', 0,
     {"v0719": '| en → en | 59 | 20 | {} | 4 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.en->en.miss', 0,
     {"v0719": '| en → en | 59 | 20 | 35 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.en->en.row_mrr', 3,
     {"v0719": '| en → en | 59 | 20 | 35 | 4 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.en->en.work_mrr', 3,
     {"v0719": '| 20 | 35 | 4 | 0,370 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.fr->en.n', 0,
     {"v0719": '| fr → en | {} | 1 | 4 | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.fr->en.win', 0,
     {"v0719": '| fr → en | 12 | {} | 4 | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.fr->en.near_win', 0,
     {"v0719": '| fr → en | 12 | 1 | {} | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.fr->en.miss', 0,
     {"v0719": '| fr → en | 12 | 1 | 4 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.fr->en.row_mrr', 3,
     {"v0719": '| fr → en | 12 | 1 | 4 | 7 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.fr->en.work_mrr', 3,
     {"v0719": '| 1 | 4 | 7 | 0,017 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.n', 0,
     {"v0719": '| vi → en | {} | 0 | 0 | 10 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.miss', 0,
     {"v0719": '| vi → en | 10 | 0 | 0 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->en.row_mrr', 3,
     {"v0719": '| vi → en | 10 | 0 | 0 | 10 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->vi.n', 0,
     {"v0719": '| vi → vi | {} | 1 | 5 | 2 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->vi.win', 0,
     {"v0719": '| vi → vi | 8 | {} | 5 | 2 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->vi.near_win', 0,
     {"v0719": '| vi → vi | 8 | 1 | {} | 2 |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->vi.miss', 0,
     {"v0719": '| vi → vi | 8 | 1 | 5 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->vi.row_mrr', 3,
     {"v0719": '| vi → vi | 8 | 1 | 5 | 2 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.vi->vi.work_mrr', 3,
     {"v0719": '| 1 | 5 | 2 | 0,042 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.row_in_top10', 0,
     {"v0719": 'was within the first ten for **{}** of the 100 questions'}),
    ('0719-generator/run.json', 'ladder.by_lane.all.work_in_top10', 0,
     {"v0719": 'with or without the paragraph — for **{}**.'}),
    ('0719-generator/run.json', 'chain_in_reply.answer_rows_found', 0,
     {"v0719": 'of the **{}** answer rows\nfound,'}),
    ('0719-generator/run.json', 'chain_in_reply.carried.entry_title', 0,
     {"v0719": 'found, **{}** carried the title and'}),
    ('0719-generator/run.json', 'ladder.by_compound.compound.n', 0,
     {"v0719": '(**{}** compound-document questions: 0 wins, 13 near-wins, 7 misses'}),
    ('0719-generator/run.json', 'ladder.by_mode.combined.win', 0,
     {"v0719": '| combined → auto | 100 | {} | 51 | 27 |'}),
    ('0719-generator/run.json', 'ladder.by_mode.combined.near_win', 0,
     {"v0719": '| combined → auto | 100 | 22 | {} | 27 |'}),
    ('0719-generator/run.json', 'ladder.by_mode.combined.miss', 0,
     {"v0719": '| combined → auto | 100 | 22 | 51 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.combined.row_mrr', 3,
     {"v0719": '| combined → auto | 100 | 22 | 51 | 27 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.combined.work_mrr', 3,
     {"v0719": '| combined → auto | 100 | 22 | 51 | 27 | 0,226 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.exact.win', 0,
     {"v0719": '| exact → keyword | 100 | {} | 42 | 35 |'}),
    ('0719-generator/run.json', 'ladder.by_mode.exact.near_win', 0,
     {"v0719": '| exact → keyword | 100 | 23 | {} | 35 |'}),
    ('0719-generator/run.json', 'ladder.by_mode.exact.miss', 0,
     {"v0719": '| exact → keyword | 100 | 23 | 42 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.exact.row_mrr', 3,
     {"v0719": '| exact → keyword | 100 | 23 | 42 | 35 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.exact.work_mrr', 3,
     {"v0719": '| exact → keyword | 100 | 23 | 42 | 35 | 0,233 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.meaning.win', 0,
     {"v0719": '| meaning → semantic | 100 | {} | 51 | 32 |'}),
    ('0719-generator/run.json', 'ladder.by_mode.meaning.near_win', 0,
     {"v0719": '| meaning → semantic | 100 | 17 | {} | 32 |'}),
    ('0719-generator/run.json', 'ladder.by_mode.meaning.miss', 0,
     {"v0719": '| meaning → semantic | 100 | 17 | 51 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.meaning.row_mrr', 3,
     {"v0719": '| meaning → semantic | 100 | 17 | 51 | 32 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode.meaning.work_mrr', 3,
     {"v0719": '| meaning → semantic | 100 | 17 | 51 | 32 | 0,158 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.cross-lingual.win', 0,
     {"v0719": '| exact, cross-lingual | 30 | {} | 3 | 27 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.cross-lingual.near_win', 0,
     {"v0719": '| exact, cross-lingual | 30 | 0 | {} | 27 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.cross-lingual.miss', 0,
     {"v0719": '| exact, cross-lingual | 30 | 0 | 3 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.cross-lingual.row_mrr', 3,
     {"v0719": '| exact, cross-lingual | 30 | 0 | 3 | 27 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.cross-lingual.work_mrr', 3,
     {"v0719": '| exact, cross-lingual | 30 | 0 | 3 | 27 | 0,011 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.cross-lingual.win', 0,
     {"v0719": '| meaning, cross-lingual | 30 | {} | 8 | 21 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.cross-lingual.near_win', 0,
     {"v0719": '| meaning, cross-lingual | 30 | 1 | {} | 21 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.cross-lingual.miss', 0,
     {"v0719": '| meaning, cross-lingual | 30 | 1 | 8 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.cross-lingual.row_mrr', 3,
     {"v0719": '| meaning, cross-lingual | 30 | 1 | 8 | 21 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.cross-lingual.work_mrr', 3,
     {"v0719": '| meaning, cross-lingual | 30 | 1 | 8 | 21 | 0,011 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.same-language.win', 0,
     {"v0719": '| exact, same language | 70 | {} | 39 | 8 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.same-language.near_win', 0,
     {"v0719": '| exact, same language | 70 | 23 | {} | 8 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.same-language.miss', 0,
     {"v0719": '| exact, same language | 70 | 23 | 39 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.same-language.row_mrr', 3,
     {"v0719": '| exact, same language | 70 | 23 | 39 | 8 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.same-language.work_mrr', 3,
     {"v0719": '| exact, same language | 70 | 23 | 39 | 8 | 0,329 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.same-language.win', 0,
     {"v0719": '| meaning, same language | 70 | {} | 43 | 11 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.same-language.near_win', 0,
     {"v0719": '| meaning, same language | 70 | 16 | {} | 11 |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.same-language.miss', 0,
     {"v0719": '| meaning, same language | 70 | 16 | 43 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.same-language.row_mrr', 3,
     {"v0719": '| meaning, same language | 70 | 16 | 43 | 11 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.same-language.work_mrr', 3,
     {"v0719": '| meaning, same language | 70 | 16 | 43 | 11 | 0,220 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.exact.cross-lingual.work_in_top10', 0,
     {"v0719": 'the keyword half finds the\nwork {} times in 30'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_cross_lingual.meaning.cross-lingual.work_in_top10', 0,
     {"v0719": 'the vector half\n{} times'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_lane.meaning.fr->en.near_win', 0,
     {"v0719": 'is 0 near-wins in `exact` and **{}** near-wins in `meaning`'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_lane.exact.vi->en.miss', 0,
     {"v0719": 'lane (10) is **{}** misses in all three modes'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_lane.exact.vi->vi.win', 0,
     {"v0719": 'reads the other way: **{}** wins in `exact`'}),
    ('0719-generator/run.json', 'ladder.by_mode_and_lane.meaning.vi->vi.win', 0,
     {"v0719": 'wins in `exact`, **{}** in `meaning`'}),
    ('0719-generator/run.json', 'ladder.by_cross_lingual.same-language.work_in_top10', 0,
     {"v0719": 'found the work nine times in ten\n({} of 70)'}),
    ('0719-generator/run.json', 'ladder.by_reachability.within-cap.n', 0,
     {"v0719": '| within the body-text cap | {} | 21 | 29 | 22 |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.within-cap.win', 0,
     {"v0719": '| within the body-text cap | 72 | {} | 29 | 22 |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.within-cap.near_win', 0,
     {"v0719": '| within the body-text cap | 72 | 21 | {} | 22 |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.within-cap.miss', 0,
     {"v0719": '| within the body-text cap | 72 | 21 | 29 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.within-cap.row_mrr', 3,
     {"v0719": '| within the body-text cap | 72 | 21 | 29 | 22 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.beyond-cap.n', 0,
     {"v0719": '| beyond the body-text cap | {} | 1 | 22 | 5 |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.beyond-cap.win', 0,
     {"v0719": '| beyond the body-text cap | 28 | {} | 22 | 5 |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.beyond-cap.near_win', 0,
     {"v0719": '| beyond the body-text cap | 28 | 1 | {} | 5 |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.beyond-cap.miss', 0,
     {"v0719": '| beyond the body-text cap | 28 | 1 | 22 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.beyond-cap.row_mrr', 3,
     {"v0719": '| beyond the body-text cap | 28 | 1 | 22 | 5 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_reachability.within-cap.row_in_top10', 0,
     {"v0719": 'The answer row was found\nfor **{}** of the 72 within'}),
    ('0719-generator/run.json', 'ladder.by_reachability.beyond-cap.row_in_top10', 0,
     {"v0719": 'within and for **{}** of the 28 beyond'}),
    ('0719-generator/run.json', 'ladder.by_format.pdf.n', 0,
     {"v0719": '| PDF | {} | 13 | 38 | 20 |'}),
    ('0719-generator/run.json', 'ladder.by_format.pdf.win', 0,
     {"v0719": '| PDF | 71 | {} | 38 | 20 |'}),
    ('0719-generator/run.json', 'ladder.by_format.pdf.near_win', 0,
     {"v0719": '| PDF | 71 | 13 | {} | 20 |'}),
    ('0719-generator/run.json', 'ladder.by_format.pdf.miss', 0,
     {"v0719": '| PDF | 71 | 13 | 38 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_format.pdf.row_mrr', 3,
     {"v0719": '| PDF | 71 | 13 | 38 | 20 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_format.html.n', 0,
     {"v0719": '| HTML | {} | 9 | 13 | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_format.html.win', 0,
     {"v0719": '| HTML | 29 | {} | 13 | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_format.html.near_win', 0,
     {"v0719": '| HTML | 29 | 9 | {} | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_format.html.miss', 0,
     {"v0719": '| HTML | 29 | 9 | 13 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_format.html.row_mrr', 3,
     {"v0719": '| HTML | 29 | 9 | 13 | 7 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_type.journalArticle.n', 0,
     {"v0719": '| journal articles | {} | 11 | 12 | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_type.journalArticle.win', 0,
     {"v0719": '| journal articles | 30 | {} | 12 | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_type.journalArticle.near_win', 0,
     {"v0719": '| journal articles | 30 | 11 | {} | 7 |'}),
    ('0719-generator/run.json', 'ladder.by_type.journalArticle.miss', 0,
     {"v0719": '| journal articles | 30 | 11 | 12 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_type.journalArticle.row_mrr', 3,
     {"v0719": '| journal articles | 30 | 11 | 12 | 7 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_type.report.n', 0,
     {"v0719": '| reports | {} | 6 | 15 | 11 |'}),
    ('0719-generator/run.json', 'ladder.by_type.report.win', 0,
     {"v0719": '| reports | 32 | {} | 15 | 11 |'}),
    ('0719-generator/run.json', 'ladder.by_type.report.near_win', 0,
     {"v0719": '| reports | 32 | 6 | {} | 11 |'}),
    ('0719-generator/run.json', 'ladder.by_type.report.miss', 0,
     {"v0719": '| reports | 32 | 6 | 15 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_type.report.row_mrr', 3,
     {"v0719": '| reports | 32 | 6 | 15 | 11 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_length.very-long.n', 0,
     {"v0719": '| very long documents | {} | 11 | 38 | 17 |'}),
    ('0719-generator/run.json', 'ladder.by_length.very-long.win', 0,
     {"v0719": '| very long documents | 66 | {} | 38 | 17 |'}),
    ('0719-generator/run.json', 'ladder.by_length.very-long.near_win', 0,
     {"v0719": '| very long documents | 66 | 11 | {} | 17 |'}),
    ('0719-generator/run.json', 'ladder.by_length.very-long.miss', 0,
     {"v0719": '| very long documents | 66 | 11 | 38 | {} |'}),
    ('0719-generator/run.json', 'ladder.by_length.very-long.row_mrr', 3,
     {"v0719": '| very long documents | 66 | 11 | 38 | 17 | {} |'}),
    ('0719-generator/run.json', 'sample.chain_measured.identifier', 0,
     {"v0719": '| identifier | **{}** | 17 |'}),
    ('0719-generator/run.json', 'sample.chain_not_measured.identifier', 0,
     {"v0719": '| identifier | **83** | {} |'}),
    ('0719-generator/run.json', 'sample.chain_measured.page_index', 0,
     {"v0719": '| PDF page index | **{}** | 37 |'}),
    ('0719-generator/run.json', 'sample.chain_not_measured.page_index', 0,
     {"v0719": '| PDF page index | **63** | {} |'}),
    ('0719-generator/run.json', 'sample.chain_measured.page_label', 0,
     {"v0719": '| printed page label | **{}** | 82 |'}),
    ('0719-generator/run.json', 'sample.chain_not_measured.page_label', 0,
     {"v0719": '| printed page label | **18** | {} |'}),
    ('0719-generator/run.json', 'sample.chain_measured.section', 0,
     {"v0719": '| section heading | **{}** | 11 |'}),
    ('0719-generator/run.json', 'sample.chain_not_measured.section', 0,
     {"v0719": '| section heading | **89** | {} |'}),
    ('0719-generator/run.json', 'sample.within_default_cap', 0,
     {"v0719": 'against that cap, {} within and 28 beyond'}),
    ('0719-generator/run.json', 'sample.beyond_default_cap', 0,
     {"v0719": 'against that cap, 72 within and {} beyond'}),
    # ---- 0711, the library census behind the Menagerie's representative core. Every
    # figure the report bolds is declared: the fixture will be quota-sampled against
    # these, so a stale one here mis-sizes a cell of the corpus rather than a sentence.
    ('0029-library-census/census.json', 'personal.items_total', 0,
     {"v0711": '| items | **{}** |'}),
    ('0029-library-census/census.json', 'groups.305258.items_total', 0,
     {"v0711": '**{}** | | top-level records |'}),
    ('0029-library-census/census.json', 'personal.top_level_records', 0,
     {"v0711": '| top-level records | **{}** |'}),
    ('0029-library-census/census.json', 'groups.305258.top_level_records', 0,
     {"v0711": '**{}** | | attachments |'}),
    ('0029-library-census/census.json', 'personal.attachments.total', 0,
     {"v0711": '| attachments | **{}** |'}),
    ('0029-library-census/census.json', 'groups.305258.attachments', 0,
     {"v0711": '**{}** | | notes |'}),
    ('0029-library-census/census.json', 'personal.notes.total', 0,
     {"v0711": '| notes | **{}** |'}),
    ('0029-library-census/census.json', 'groups.305258.notes', 0,
     {"v0711": '**{}** | | full-text entries |'}),
    ('0029-library-census/census.json', 'personal.fulltext.entries_in_census', 0,
     {"v0711": '| full-text entries | **{}** |'}),
    ('0029-library-census/census.json', 'groups.305258.fulltext_entries', 0,
     {"v0711": '**{}** | | items in the trash |'}),
    ('0029-library-census/census.json', 'personal.trash.items', 0,
     {"v0711": '| items in the trash | **{}** |'}),
    ('0029-library-census/census.json', 'groups.305258.trash_items', 0,
     {"v0711": '**{}** | The personal library has'}),
    ('0029-library-census/census.json', 'sqlite.feed_libraries', 0,
     {"v0711": 'Feed libraries: **{}**, so'}),
    ('0029-library-census/census.json', 'sqlite.annotations_by_library_type.group.highlight', 0,
     {"v0711": '({} highlights,'}),
    ('0029-library-census/census.json', 'sqlite.annotations_by_library_type.group.image', 0,
     {"v0711": '{} images), none in'}),
    ('0029-library-census/census.json', 'personal.item_types.journalArticle', 0,
     {"v0711": '| journalArticle | **{}** |'}),
    ('0029-library-census/census.json', 'personal.item_types.report', 0,
     {"v0711": '| report | **{}** |'}),
    ('0029-library-census/census.json', 'personal.item_types.webpage', 0,
     {"v0711": '| webpage | **{}** |'}),
    ('0029-library-census/census.json', 'personal.item_types.book', 0,
     {"v0711": '| book | **{}** |'}),
    ('0029-library-census/census.json', 'personal.attachments_per_record.0', 0,
     {"v0711": '| 0 | **{}** |'}),
    ('0029-library-census/census.json', 'personal.attachments_per_record.1', 0,
     {"v0711": '| 1 | **{}** |'}),
    ('0029-library-census/census.json', 'personal.attachments_per_record.2', 0,
     {"v0711": '| 2 | **{}** |'}),
    ('0029-library-census/census.json', 'personal.attachments_per_record_quantiles.max', 0,
     {"v0711": 'maximum **{}**. Counting PDFs'}),
    ('0029-library-census/census.json', 'personal.attachments.content_type.application/pdf', 0,
     {"v0711": '| application/pdf | **{}** | 56,9'}),
    ('0029-library-census/census.json', 'personal.attachments.content_type.text/html', 0,
     {"v0711": '| text/html | **{}** | 33,0'}),
    ('0029-library-census/census.json', 'personal.attachments.link_mode.imported_file', 0,
     {"v0711": '`imported_file` **{}** ('}),
    ('0029-library-census/census.json', 'personal.attachments.link_mode.imported_url', 0,
     {"v0711": '`imported_url` **{}** ('}),
    ('0029-library-census/census.json', 'personal.attachments.link_mode.linked_url', 0,
     {"v0711": '`linked_url` **{}** ('}),
    ('0029-library-census/census.json', 'personal.attachments.link_mode.linked_file', 0,
     {"v0711": '`linked_file` **{}** ('}),
    ('0029-library-census/census.json', 'personal.notes.standalone', 0,
     {"v0711": '**{}** standalone. 619 records'}),
    ('0029-library-census/census.json', 'personal.notes.length_chars_quantiles.p50', 0,
     {"v0711": 'median **{}**, p75'}),
    ('0029-library-census/census.json', 'personal.notes.length_chars_quantiles.max', 0,
     {"v0711": 'maximum **{}**. The distribution'}),
    ('0029-library-census/census.json', 'personal.language.records_with_language', 0,
     {"v0711": '**{}** records (48,4 %) carry a language'}),
    ('0029-library-census/census.json', 'personal.language.normalised.en', 0,
     {"v0711": '| en | **{}** |'}),
    ('0029-library-census/census.json', 'personal.language.normalised.vi', 0,
     {"v0711": '| vi | **{}** |'}),
    ('0029-library-census/census.json', 'personal.language.normalised.fr', 0,
     {"v0711": '| fr | **{}** |'}),
    ('0029-library-census/census.json', 'personal.records.title_script.latin_with_diacritics', 0,
     {"v0711": 'diacritics **{}** (15,1 %)'}),
    ('0029-library-census/census.json', 'personal.collections.records_in_collections', 0,
     {"v0711": '**{}** records (83,3 %) sit in'}),
    ('0029-library-census/census.json', 'personal.records.with_abstract', 0,
     {"v0711": '**{}** records (41,4 %) carry an abstract'}),
    ('0029-library-census/census.json', 'personal.records.with_tags', 0,
     {"v0711": '**{}** records (17,5 %) carry a tag'}),
    ('0029-library-census/census.json', 'personal.records.decade.2000s', 0,
     {"v0711": '2000s **{}** (21,5 %)'}),
    ('0029-library-census/census.json', 'personal.records.decade.2010s', 0,
     {"v0711": '2010s **{}** (43,0 %)'}),
    ('0029-library-census/census.json', 'personal.records.decade.2020s', 0,
     {"v0711": '2020s **{}** (26,7 %)'}),
    ('0029-library-census/census.json', 'personal.fulltext.entries_version_zero', 0,
     {"v0711": 'of which **{}** are at version 0'}),
    ('0029-library-census/census.json', 'personal.fulltext.by_content_type.application/pdf.file_attachments', 0,
     {"v0711": '| application/pdf | **{}** | **'}),
    ('0029-library-census/census.json', 'personal.fulltext.by_content_type.application/pdf.state.indexed', 0,
     {"v0711": '**{}** | **584** | **460** | 0 |'}),
    ('0029-library-census/census.json', 'personal.fulltext.by_content_type.application/pdf.state.partial', 0,
     {"v0711": '**{}** | **460** | 0 |'}),
    ('0029-library-census/census.json', 'personal.fulltext.by_content_type.application/pdf.state.unindexed', 0,
     {"v0711": '**{}** | 0 | | text/html |'}),
    ('0029-library-census/census.json', 'personal.fulltext.by_content_type.text/html.file_attachments', 0,
     {"v0711": '| text/html | **{}** | **'}),
    ('0029-library-census/census.json', 'personal.fulltext.by_content_type.text/html.state.indexed', 0,
     {"v0711": '**{}** | 0 | 113 | 22 |'}),
    ('0029-library-census/census.json', 'personal.fulltext.quantiles.totalPages.p50', 0,
     {"v0711": '| 5 | 9 | **{}** | 46 |'}),
    ('0029-library-census/census.json', 'personal.fulltext.quantiles.totalPages.p90', 0,
     {"v0711": '| 46 | **{}** | **552** |'}),
    ('0029-library-census/census.json', 'personal.fulltext.quantiles.totalPages.p99', 0,
     {"v0711": '**{}** | **3 949** |'}),
    ('0029-library-census/census.json', 'personal.fulltext.quantiles.totalPages.max', 0,
     {"v0711": '**{}** | 54,2 |'}),
    ('0029-library-census/census.json', 'personal.fulltext.quantiles.totalChars.p50', 0,
     {"v0711": '| 4 162 | **{}** | 15 200 |'}),
    ('0029-library-census/census.json', 'personal.fulltext.caps.with_page_counters', 0,
     {"v0711": 'of the {} PDFs with page counters'}),
    ('0029-library-census/census.json', 'personal.fulltext.caps.pages_over_stock_cap', 0,
     {"v0711": '**{}** of the 4 779 PDFs'}),
    ('0029-library-census/census.json', 'personal.fulltext.caps.pages_truncated_at_stock_cap', 0,
     {"v0711": '**{}** of them (94,0 %'}),
    ('0029-library-census/census.json', 'personal.fulltext.caps.pages_indexed_beyond_stock_cap', 0,
     {"v0711": '**{}** are indexed beyond it'}),
    ('0029-library-census/census.json', 'personal.fulltext.caps.chars_over_stock_cap', 0,
     {"v0711": '**{}** text attachments exceed'}),
    ('0029-library-census/census.json', 'personal.fulltext.caps.chars_truncated_at_stock_cap', 0,
     {"v0711": 'and **{}** are truncated'}),
