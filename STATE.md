...
| pool | fixture | **real** | centred | two-stage | vs exact (101,2 ms) |
|---|---|---|---|---|---|
| 4x (k=120) | 0,628 | **0,884** | 0,918 | 33,4 ms | **~3,0x faster** |
| 8x (k=240) | 0,862 | **0,953** | 0,969 | 59,9 ms | **~1,7x faster** |
| 16x (k=480) | 0,998 | 0,986 | 0,991 | 119,2 ms | ~0,85x — slower |
...
ordering; interleaving and shuffling brought them to 1,4-9,9%, and all three
...
it is 30,3 ms of the 59,9, and the rest is the rerank issuing one round trip per
