...
| fork | `main` aligned with upstream at `309204b`; merged branches deleted; historical storage tree preserved as `archive/fts5-storage-2026-08-21` at `bae82a7`; active branches `schema-read-before-write` (`fd51659`, PR #25) and `stopwords-follow-up`, both from `309204b` |
