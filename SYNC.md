...
| gates | fold-gate waiver retired with #19's merge (0026, SPEC.md §5.2.8); stock ≥v1.7.2 carries `normalizeForSearch`, so the fold gate runs green against it |
...
| next | the train of SPEC.md §5.4 as ratified (DECISIONS.md 2026-08-26, event record 2026-08-27); live state in tickets 0014–0037 — `erg ready` is the queue |
...
**Order of operations**: superseded — the plan of record is SPEC.md §5.4 as
