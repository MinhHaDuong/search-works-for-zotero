...
concurrency, query, operator) re-ran the design against **sheet v2** — DESIGN.md as amended
by the four ratification-log rulings, DESIGN-DELTA.md (R10–R28, C4, D1–D11 resolved), and
SCOUTS.md's sheet-candidate sharpenings — each adversarially critiqued, this synthesis
assembled from what survived plus named repairs. The incumbent is DESIGN-V1.md ("The Settled
Ledger"), written against sheet v1. Resolved decisions and rulings are not reopened here;
scout findings are binding input.*
