...
artifact under `bench/results/smoke-1.12.0/` predates the three newest checks and
is regenerated by that target on a machine carrying an isolation mechanism, which
this rung's own R10 clause needs and nothing else here does.
